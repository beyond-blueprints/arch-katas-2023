...
- System will collect user's identity information like Passport Number, any local identifiers that can be used to fetch the trip information at the time of initial setup of data post registration.
- System will only show ongoing and future events.
- All data sources support Pub/Sub model for updates and Road Warriors will subscribe to specific topics to get real time updates.
...
* **Road Warrior Mobile & Web UI App**: The Mobile and Web UI tier provides visually rich and responsive user interfaces for the Road Warrior application, enabling travelers to access and interact with their trip data effortlessly on both web browsers and mobile devices.
* **Road Warrior Analytics & Reporting Web App**: The Road Warrior analytics and reporting service backoffice application will provide analytics to road warrior employees on the user engagement. They can also visualize different aspects of the data collected from user trip information and create a monetization startegy.
